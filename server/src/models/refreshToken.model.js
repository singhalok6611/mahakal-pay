...
const RefreshTokenModel = {
  create({ userId, token, userAgent, ipAddress }) {
  ...
  cleanupExpired() {
    db.prepare('DELETE FROM refresh_tokens WHERE expires_at < CURRENT_TIMESTAMP OR revoked = 1').run();
  },
};
